...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SLCycleImageView/SLCycleImageView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SLFlowCollectionView/SLFlowCollectionView.framework"
fi
